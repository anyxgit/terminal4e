...
//			String nl = Locale.getDefault().toString();
			String nl = locale == null ? Locale.getDefault().toString() : locale.toString();
...
//		}
	 ...
	 */
	static void load(final String bundleName, Class<?> clazz, Locale locale) {
		...
		log(SEVERITY_WARNING, "NLS: " + bundleName + " loaded in " + (end - start) + " ms", null); //$NON-NLS-1$
	}
